...
def play_gif(frames):
    ...
    pet_window.after(100, play_gif, frames)
...
pet_window.geometry('100x100+' + str(x) + '+500')  # imagine border
# window configuration
pet_window.config(highlightbackground='black')
pet_window.overrideredirect(True)
pet_window.wm_attributes('-transparentcolor', 'black')
